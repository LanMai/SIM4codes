function [fG1, fG2] = SIMfreqDeconvAngF( n, ModFac, ...
                    OTFo, Snoisy, Spattern, PSFe, MaskPetals, doubleSize, DIo)
                
% DIo: is used here for verifying and not for estimation
...
Tbegin = toc;
for i = 1:n
    [ Mtemp{i}, Ftemp{i}, NoiseStd{i}  ] = SIMangMatrixF( ModFac, Kotf, MaskPetals, ...
        Snoisy(:,:,i), Spattern(:,:,i), PSFe, OTFo, doubleSize, DIo ); 
    [100*i toc]
end
Tend = toc;
dT = Tend - Tbegin
