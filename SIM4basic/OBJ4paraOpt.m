function Esum = OBJ4paraOpt(OBJpara0,fDIoTnoisy,NoisePower,OTFo)
...
Zloop = (Ro<0.75*Kotf).*(Ro>0.15*Kotf); % when k2 = 80.0
% Zloop = (Ro<0.45*Kotf).*(Ro>0.15*Kotf); % for SinePatterns
